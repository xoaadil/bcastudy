...
import { ArrowLeft, ExternalLink, Code, BookOpen, Lightbulb, Zap } from "lucide-react";
     ...
     <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-6">
       ...
       <div className="relative z-10 text-center mb-12">
         ...
         <p className="text-gray-300 text-xl max-w-2xl mx-auto">
           Learn from mistakes and experiences to make better life decisions
         </p>
         ...
         {coding.map((item, index) => (
           ...
           >
             ...
             <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 shadow-2xl hover:shadow-blue-500/25">
               ...
               <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-pulse" style={{animationDelay: '0.5s'}}></div>
             </div>
           </div>
         ))}
       </div>
       ...
       <div className="relative z-10 mt-16 text-center">
         <Link to="/" className="inline-flex items-center gap-2 text-blue-400 hover:text-cyan-400 transition-colors duration-300 font-medium text-lg group">
